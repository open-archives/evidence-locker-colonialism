# Evidence Locker Entry 3 — Part 1: Early Contact & Dispossession (1492–1800s)
...
## Part 1: Timeline — Early Phase (1492–1800s)

| Year | Event | Key Actors | Impact |
|------|-------|------------|--------|
| **1493** | Papal Bull *Inter Caetera* (Doctrine of Discovery) | Pope Alexander VI | Gave Catholic monarchs (Spain/Portugal) rights to colonize “non‑Christian” lands; later used by Britain/U.S. |
| **1497** | John Cabot claims Newfoundland for England | England | First English claim in North America |
| **1534** | Jacques Cartier claims St. Lawrence Valley for France | France | Foundation of New France (Quebec) |
| **1607** | Jamestown colony established | England | First permanent English settlement; Powhatan Confederacy begins resisting |
| **1620** | Plymouth (Mayflower) — Pilgrims | England | Wampanoag initially assist; later war and dispossession |
| **1763** | Royal Proclamation | British Crown | Set aside lands west of Appalachians for Indigenous peoples — **the first “reservation” concept**; immediately violated by settlers |
| **1778** | First U.S. treaty with Indigenous nation (Delaware) | U.S. Continental Congress | Established pattern of “recognizing” tribes in exchange for land cessions |
| **1783** | Treaty of Paris (ends U.S. Revolution) | U.S., Britain | Britain ceded Indigenous lands (without Indigenous consent) to U.S.; legal precedent for “conquest” |
| **1790** | Indian Intercourse Act | U.S. Congress | Regulated trade and land purchases — *required* federal approval for all land deals; widely ignored |
| **1803** | Louisiana Purchase | U.S., France | Doubled U.S. territory; all Indigenous claims in that territory were considered “void” by the U.S. |
| **1823** | *Johnson v. McIntosh* (Supreme Court) | U.S. Supreme Court (John Marshall) | Ruled that Indigenous peoples had *“right of occupancy”* but not *“right of title”* — the U.S. held ultimate title via discovery doctrine. This is the **foundational theft ruling**. |
| **1830** | Indian Removal Act (end of early period) | U.S. Congress, Andrew Jackson | Legalized forced removal of Southeastern tribes (Cherokee, Choctaw, etc.) — leads to Trail of Tears |

---

## Part 2: Claim‑vs‑Evidence Table (Early Phase)

| Claim | Supported by Data? | Source Evidence | Qualifiers |
|-------|-------------------|-----------------|------------|
| **Doctrine of Discovery was used by U.S. Supreme Court (1823)** | ✅ Yes | *Johnson v. McIntosh* (1823) full text | Marshall himself expressed regret; but applied it anyway |
| **Royal Proclamation (1763) was intended to protect Indigenous lands** | ✅ Yes | Text of Proclamation; British Cabinet minutes | *Immediately* violated by colonial settlers; treaties later ignored it |
| **Treaty of Paris (1783) transferred Indigenous lands without their consent** | ✅ Yes | Treaty text; no Indigenous signatories | Britain had no authority to transfer lands it didn’t own (in law), but did so anyway |
| **Over 370 treaties were signed between U.S. and Indigenous nations (1778–1868)** | ✅ Yes | U.S. State Department treaty list; National Archives | Almost all were broken by the U.S.; counted as “failed promises” |
| **Louisiana Purchase (1803) was made without consulting any Indigenous tribes** | ✅ Yes | Jefferson’s correspondence; treaty records | Jefferson privately hoped Indigenous peoples would “merge” or move west |
| ***Johnson v. McIntosh* (1823) established that Natives have "occupancy" but not "title"** | ✅ Yes | Supreme Court decision; legal analysis | This ruling has never been fully overturned; it still underpins U.S. property law regarding Natives |
| **French colonial policy was more trade‑oriented than land‑taking (initially)** | ⚠️ Partially | French colonial records; fur trade ledgers | French *did* take land for forts/farms, but less aggressively than British/Americans; they also intermarried more |
| **Spain encomienda system (in the Southwest/Florida) was forced labour** | ✅ Yes | Spanish colonial archives | Applied primarily to Pueblo peoples in New Mexico; revolt (1680) temporarily expelled Spanish |

---

## Part 3: Key Legal Mechanisms of Dispossession

| Mechanism | Description | Modern Legacy |
|-----------|-------------|---------------|
| **Doctrine of Discovery** | Papal bulls + subsequent court rulings | Still cited in U.S. law; never repudiated by Supreme Court |
| **Treaties** | Bilateral “nation‑to‑nation” agreements | Most broken; tribes still fight for treaty rights in courts |
| **Allotment (later, Dawes Act 1887)** | Breaking communal land into individual parcels; surplus sold to whites | Fractionated land ownership; loss of 90 million acres |
| **"Right of Occupancy" vs. "Title"** | Legal distinction invented by Marshall | Tribes are “domestic dependent nations” — not fully sovereign |
| **Manifest Destiny** | Ideological justification for expansion | Embedded in U.S. exceptionalism; still affects policy |
...
|---------------|------------|
| `EL-COL-01` (Berlin Conference) | Parallel arbitrary border‑drawing — both ignored existing populations |
| `EL-COL-02` (Indochina) | U.S. used same “counterinsurgency” tactics on Native peoples (e.g., 1862 Dakota War) |
| `EL-COL-05` (Religious Missionaries) | Catholic and Protestant missionaries ran boarding schools (see Entry 3, Part 3) |
| `EL-COL-06` (Post‑Colonial Economics) | Reservations are economic colonies — extractive industries (oil, gas, uranium) without local benefit |
| `EL-MEDIA-CONSOLIDATION` | Hollywood’s “cowboy & Indian” narrative justified dispossession for generations |
...
|----------|----------------|-----|
| **Pre‑contact population estimates** | Ranges from 2M to 18M (North America) | No census; widely disputed |
| **Number of Natives killed directly vs. disease** | Estimates 90% died from disease (smallpox) | Exact ratio impossible to determine; intentional germ warfare *documented* at Fort Pitt (1763) |
| **Total land area ceded vs. retained** | ~1.5 billion acres ceded; ~50M acres retained | Discrepancies in survey records |
| **Enforcement records for Indian Intercourse Act (1790)** | Some federal cases exist | Local violations rarely prosecuted; pattern of impunity |
| **French colonial records on trade vs. land-taking** | Archives in Quebec and Paris | Many not digitized; access limited |
...
|--------|------|----------------|---------------|
| *Inter Caetera* (1493) — Papal Bull | Doctrine of Discovery text | Vatican Archives / translated online | Public |
| Royal Proclamation (1763) | British law | Library of Congress | Public |
| *Johnson v. McIntosh* (1823) | Supreme Court decision | Cornell LII | Public |
| Treaty of Paris (1783) | Treaty text | National Archives | Public |
| Indian Intercourse Act (1790) | U.S. statute | Library of Congress | Public |

### Secondary Sources

| Source | Type | Relevance |
|--------|------|-----------|
| **Deloria, V. (1988)** | *Custer Died for Your Sins* | Indigenous perspective on U.S. policy |
| **Mann, C. (2005)** | *1491* | Pre‑contact Americas (population, agriculture) |
| **Stannard, D. (1992)** | *American Holocaust* | Demographic collapse; comparisons with genocide |
| **Wilkins, D. (2002)** | *American Indian Sovereignty and the U.S. Supreme Court* | Legal analysis of *Johnson v. McIntosh* |
| **DuVal, K. (2024)** | *Native Nations* (new scholarship) | Updated tribal sovereignty history |

### Recommended Databases

- **National Archives — Native American Treaties**  
- **Library of Congress — Indigenous Digital Collections**  
- **Native Land Digital (interactive map)**  
- **Bureau of Indian Affairs — Historical Records** (Freedom of Information)
...
|----------|---------------------------|
| **Native American** | Your ancestors lived on lands that were declared “vacant” by papal bulls and Supreme Court rulings. The legal fiction of *“occupancy without title”* is directly aimed at them. |
| **Irish** | Britain used the same legal tactics in Ireland (Plantation system, Penal Laws) decades before exporting them to America. The Irish experience was the *dry run* for settler colonialism. |
| **French Canadian** | The French allied with many tribes (e.g., Huron/Wendat) but still claimed *territory* for the Crown; your ancestors may have been fur traders who intermarried, creating the Métis/First Nations connection. |
| **Black** | The lands stolen from Natives were later used for cotton plantations worked by enslaved Africans. The dispossession of one group subsidized the enslavement of another. You carry that intersection. |
...
**Navigation**: [← Return to Colonialism Series Index](../README.md) | [Next: Entry 3 — Part 2: The Removal Era →]
